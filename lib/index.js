...
const EXT_MIME = {
  ...
  mp4: 'audio/mp4', flac: 'audio/flac', webm: 'video/webm',
}
const IMG_EXT = ['png', 'jpg', 'jpeg', 'webp', 'gif', 'svg', 'bmp']
const AUD_EXT = ['mp3', 'ogg', 'wav', 'm4a', 'mp4', 'flac', 'webm']
...
(function () {
  ...
  var S = { phase: 'title', idx: 0, vars: {}, bg: null, sprites: {}, locked: {}, bgm: null, bgmVol: 1, backlog: [], line: null, typed: '', done: true, choices: null, ending: '', cgState: null, auto: false, fast: false, muted: false };
  ...
  function cgHtml() {
    ...
    if (/\.(mp4|webm|ogg|m4a)$/i.test(c.url || '')) inner = '<video class="gg-cg-media" src="' + esc(c.url) + '" autoplay muted' + (c.type === 'cg' ? ' loop' : '') + '></video>';
