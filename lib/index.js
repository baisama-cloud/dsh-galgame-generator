...
(function () {
  ...
  var S = { phase: 'title', idx: 0, vars: {}, bg: null, sprites: {}, locked: {}, faces: {}, bgm: null, bgmVol: 1, backlog: [], line: null, typed: '', done: true, choices: null, ending: '', cgState: null, auto: false, fast: false, muted: false };
  ...
  function saveToSlot(n) {
    try {
      var sv = readSaves();
      sv[String(n)] = { idx: S.idx, bg: S.bg, sprites: S.sprites, locked: S.locked, faces: S.faces, bgm: S.bgm, bgmVol: S.bgmVol, backlog: S.backlog, vars: S.vars, time: Date.now(), label: (S.line && S.line.text ? S.line.text.slice(0, 12) : '') };
  ...
  function loadFromSlot(n) {
    ...
    if (!save) return;
    S.bg = save.bg || null; S.sprites = save.sprites || {}; S.locked = save.locked || {}; S.faces = save.faces || {}; S.bgm = save.bgm || null; S.bgmVol = save.bgmVol || 1;
  ...
  function runFrom(start) {
    ...
    while (i >= 0 && i < nodes.length && guard++ < 8000) {
      ...
      if (n.type === 'sprite') {
        ...
        else { S.locked[n.char] = true; var c2 = variantOf(n.char); S.sprites[n.char] = { url: (c2 && c2.url) || null, pos: n.pos || (c2 && c2.pos) || 'center', visible: true, name: n.char }; }
        i++; continue;
      }
      if (n.type === 'face') {
  ...
  function startGame() { S.phase = 'play'; S.auto = false; S.vars = {}; S.sprites = {}; S.locked = {}; S.faces = {}; S.bgmVol = 1; runFrom(0); }
